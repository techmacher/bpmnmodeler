    ...
    <>
      ...
      <div className={`${isExpanded ? 'fixed bottom-4 left-1/2 transform -translate-x-1/2 z-[51]' : 'absolute bottom-4 left-1/2 transform -translate-x-1/2'} flex items-center bg-white rounded-lg shadow-lg border border-gray-200 p-1`}>
        <div className="flex items-center gap-1">
          {/* View Controls */}
          <Button onClick={handleFitToView} className="p-2 hover:bg-gray-100 text-gray-600" title="Fit to View">
            <ZoomIn className="h-4 w-4" />
          </Button>
          <Button onClick={handleExpand} className="p-2 hover:bg-gray-100 text-gray-600" title="Toggle Expand">
          ...
          <Button 
            ...
            className={`p-2 hover:bg-gray-100 ${showGrid ? 'text-blue-600' : 'text-gray-600'}`}
            title="Toggle Grid"
          >
          ...
          <Button 
            ...
            className={`p-2 hover:bg-gray-100 ${snapToGrid ? 'text-blue-600' : 'text-gray-600'}`}
          ...
          {/* Alignment Controls */}
          <Button onClick={handleAlignVertical} className="p-2 hover:bg-gray-100 text-gray-600" title="Align Vertical">
            <AlignJustify className="h-4 w-4 rotate-90" />
          </Button>
          <Button onClick={handleAlignHorizontal} className="p-2 hover:bg-gray-100 text-gray-600" title="Align Horizontal">
            <AlignJustify className="h-4 w-4" />
          </Button>
          <Button onClick={handleDistributeVertical} className="p-2 hover:bg-gray-100 text-gray-600" title="Distribute Vertical">
            <AlignCenter className="h-4 w-4 rotate-90" />
          </Button>
          <Button onClick={handleDistributeHorizontal} className="p-2 hover:bg-gray-100 text-gray-600" title="Distribute Horizontal">
          ...
          {/* Export Controls */}
          <Button onClick={handleExportSvg} className="p-2 hover:bg-gray-100 text-gray-600" title="Export as SVG">
            <Download className="h-4 w-4" />
          </Button>
          <Button onClick={handleExportBpmn} className="p-2 hover:bg-gray-100 text-gray-600" title="Export as BPMN">
